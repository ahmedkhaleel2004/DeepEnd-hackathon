...
import { CodeBlock } from "@/components/component/Main/CodeBlock";
    ...
    <div className="mb-4 flex items-start space-x-3">
      <div className="mt-2 overflow-hidden">
        <MemoizedReactMarkdown
          className="lg:max-w-screen prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 mr-[2rem] max-w-xs break-words sm:max-w-xl md:max-w-2xl"
